...
vignette: >
  %\VignetteIndexEntry{introduction_to_didcf}
...
This vignette accompanies the package DiDCF. The algorithms comes from *Gavrilova, Evelina, Audun Langørgen, and Floris Zoutman. "Difference-in-difference causal forests, with an application to payroll tax incidence in norway." (2025).*
